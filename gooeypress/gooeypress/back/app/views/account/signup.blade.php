...
<div class="container">
  <div class="row login-container column-seperation">  
        <div class="col-md-6 col-md-offset-3"> <br>
		 <form id="login-form" class="login-form" action="{{ url('account/signup') }}" method="post">
		 <div class="row">
		 ...
		 <div class="row">
		 <div class="form-group col-md-10">
            <label class="form-label">Nicename</label>
            <div class="controls">
				<div class="input-with-icon  right">                                       
					<i class=""></i>
					<input type="text" name="nicename" id="txtusername" class="form-control">                                 
				</div>
            </div>
          </div>
          </div>
